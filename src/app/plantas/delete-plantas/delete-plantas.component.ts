...
@Component({
  selector: 'app-delete-plantas',
  templateUrl: './delete-plantas.component.html',
  styleUrls: ['./delete-plantas.component.css']
})
export class DeletePlantasComponent {
  constructor(public dialogRef: MatDialogRef<DeletePlantasComponent>,
